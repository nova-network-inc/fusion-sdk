...
export const WETH = {
  ...
  [ChainId.NEBULA]: new Token(ChainId.NEBULA, '0x7e2D6Ac6cEAAa20a3Cc4CA4c1b0dFC6b95332A9d', 18, 'WNBK', 'Wrapped NBX'),
  [ChainId.ETC]: new Token(ChainId.ETC, '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', 18, 'WNBK', 'Wrapped ETC')
}
